...
### Сессия
##### Сервис:
Внешний RPS авторизации составляет 2.314. Для него потребуются максимум 2 сервера. Также к сервису авторизации обращаюся все остальные сервисы для проверки авторизации для тогда добавляется 9.257 RPS. Всего 11.571 RPS. Тогда на сервисе сессий нам понадобиться 2 сервера.
Параметр | Значение
------------ | -------------
CPU | 4
RAM | 8Gb
