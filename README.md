...
Для хранени картинок будет ипользовать S3 хранилище.
...
Бекенд будет присать на Go. Он будет состоять из нескольких частей: сервиса авторизации, сервис видеозвонков, сервис сообщений. Сервис видеозвонков разобьем на три микросервиса: микросерви загрузки видео/аудио, микросервис перекодировки видео, микросервис раздачи видео/аудио. Протокол общения между бекендом и фронтендом - https.
